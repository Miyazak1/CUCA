...
const requiredKeys = [
  ...
  "CUAC_DATA_RIGHTS_REMINDER_POLL_MS",
  "CUAC_DATA_RIGHTS_REMINDER_BATCH_SIZE",
  "CUAC_DATA_RIGHTS_REMINDER_WORKER_SUPERVISED",
