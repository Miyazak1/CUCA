(function initCatalogDetailI18n() {
  ...
  const rows = [
    ...
    ["Back to cities", "Quay lại thành phố", "กลับไปยังเมือง", "Kembali ke kota", "Kembali ke bandar", "العودة إلى المدن"],
    ["City catalog context", "Thông tin danh mục thành phố", "บริบทแค็ตตาล็อกเมือง", "Konteks katalog kota", "Konteks katalog bandar", "سياق دليل المدينة"],
    ["Living context", "Bối cảnh sinh hoạt", "บริบทการอยู่อาศัย", "Konteks kehidupan", "Konteks kehidupan", "سياق المعيشة"],
    ["Cost and city profile", "Chi phí và hồ sơ thành phố", "ค่าใช้จ่ายและข้อมูลเมือง", "Biaya dan profil kota", "Kos dan profil bandar", "التكلفة وملف المدينة"],
    ["Monthly cost", "Chi phí hàng tháng", "ค่าใช้จ่ายรายเดือน", "Biaya bulanan", "Kos bulanan", "التكلفة الشهرية"],
    ["Monthly cost reference", "Tham chiếu chi phí tháng", "ข้อมูลอ้างอิงค่าใช้จ่ายรายเดือน", "Referensi biaya bulanan", "Rujukan kos bulanan", "مرجع التكلفة الشهرية"],
    ["Cost level", "Mức chi phí", "ระดับค่าใช้จ่าย", "Tingkat biaya", "Tahap kos", "مستوى التكلفة"],
    ["City density", "Mật độ thành phố", "ความหนาแน่นของเมือง", "Kepadatan kota", "Kepadatan bandar", "كثافة المدينة"],
    ["City record", "Hồ sơ thành phố", "ระเบียนเมือง", "Catatan kota", "Rekod bandar", "سجل المدينة"],
    ["Source-backed city information", "Thông tin thành phố có nguồn", "ข้อมูลเมืองที่มีแหล่งอ้างอิง", "Informasi kota bersumber", "Maklumat bandar bersumber", "معلومات مدينة مدعومة بالمصدر"],
    ["Published reference counts", "Số liệu tham chiếu đã công bố", "จำนวนข้อมูลอ้างอิงที่เผยแพร่", "Jumlah referensi diterbitkan", "Bilangan rujukan diterbitkan", "أعداد المراجع المنشورة"],
    ["CSCA universities", "Trường yêu cầu CSCA", "มหาวิทยาลัยที่ใช้ CSCA", "Universitas CSCA", "Universiti CSCA", "جامعات CSCA"],
    ["Nearby", "Lân cận", "ใกล้เคียง", "Terdekat", "Berdekatan", "بالقرب"],
    ["Published nearby references", "Tham chiếu lân cận đã công bố", "ข้อมูลอ้างอิงใกล้เคียงที่เผยแพร่", "Referensi sekitar diterbitkan", "Rujukan berdekatan diterbitkan", "مراجع قريبة منشورة"],
    ["Tags", "Nhãn", "แท็ก", "Tag", "Tag", "الوسوم"],
    ["Source-backed catalog labels", "Nhãn danh mục có nguồn", "ป้ายแค็ตตาล็อกที่มีแหล่งอ้างอิง", "Label katalog bersumber", "Label katalog bersumber", "تسميات دليل مدعومة بالمصدر"],
    ["Explore this city", "Khám phá thành phố này", "สำรวจเมืองนี้", "Jelajahi kota ini", "Teroka bandar ini", "استكشف هذه المدينة"],
    ["Browse universities", "Xem trường đại học", "ดูมหาวิทยาลัย", "Jelajahi universitas", "Lihat universiti", "تصفح الجامعات"],
    ["Browse programs", "Xem chương trình", "ดูหลักสูตร", "Jelajahi program", "Lihat program", "تصفح البرامج"],
    ["Browse scholarships", "Xem học bổng", "ดูทุนการศึกษา", "Jelajahi beasiswa", "Lihat biasiswa", "تصفح المنح"],
    ["Overview", "Tổng quan", "ภาพรวม", "Ringkasan", "Gambaran keseluruhan", "نظرة عامة"],
    ["Budget summary", "Tóm tắt ngân sách", "สรุปงบประมาณ", "Ringkasan anggaran", "Ringkasan bajet", "ملخص الميزانية"],
    ["Quick facts", "Thông tin nhanh", "ข้อมูลสำคัญ", "Fakta singkat", "Fakta ringkas", "حقائق سريعة"],
    ["Cost profiles", "Hồ sơ chi phí", "รูปแบบค่าใช้จ่าย", "Profil biaya", "Profil kos", "ملفات التكلفة"],
    ["Cost breakdown", "Chi tiết chi phí", "รายละเอียดค่าใช้จ่าย", "Rincian biaya", "Pecahan kos", "تفصيل التكلفة"],
    ["Student life", "Đời sống sinh viên", "ชีวิตนักศึกษา", "Kehidupan mahasiswa", "Kehidupan pelajar", "حياة الطالب"],
    ["Transport", "Giao thông", "การเดินทาง", "Transportasi", "Pengangkutan", "النقل"],
    ["Application advice", "Lời khuyên nộp hồ sơ", "คำแนะนำการสมัคร", "Saran pendaftaran", "Nasihat permohonan", "نصائح التقديم"],
    ["Best for", "Phù hợp với", "เหมาะสำหรับ", "Cocok untuk", "Sesuai untuk", "الأنسب لـ"],
