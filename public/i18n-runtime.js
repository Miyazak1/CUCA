(function initCuacI18n() {
  ...
  const copy = {
    en: {
      ...
      "home.destinationNotice": "Catalog navigation and core detail labels are translated. Official names, admissions content, city pages, and guides remain in English while reviewed translations are completed.",
    ...
    vi: {
      ...
      "home.boundaryTitle": "Phạm vi hỗ trợ quan trọng", "home.boundaryBody": "CUAC hỗ trợ tìm kiếm và sắp xếp lựa chọn. Trong phiên bản này, sinh viên nộp hồ sơ qua kênh chính thức của từng trường.", "home.accountTitle": "Quản lý các lựa chọn du học Trung Quốc", "home.accountBody": "Lưu chương trình, so sánh lộ trình và theo dõi kỳ nhập học trong một không gian sinh viên.", "home.create": "Tạo danh sách", "home.destinationNotice": "Điều hướng danh mục và nhãn chi tiết cốt lõi đã được dịch. Tên chính thức, nội dung tuyển sinh, trang thành phố và hướng dẫn vẫn bằng tiếng Anh trong khi bản dịch được rà soát.", "home.feedback.search": "Nhấn Enter hoặc Tìm kiếm để xem kết quả đã công bố.", "home.feedback.empty": "Nhập chương trình, trường đại học, học bổng hoặc thành phố.",
    },
    th: {
    ...
    id: {
      ...
      "home.boundaryTitle": "Batas penting layanan pendaftaran", "home.boundaryBody": "CUAC membantu menemukan dan mengatur pilihan. Pada rilis ini, pelajar mengirim dokumen melalui kanal resmi setiap universitas.", "home.accountTitle": "Satukan pilihan studi di Tiongkok", "home.accountBody": "Simpan program, bandingkan jalur, dan pantau jadwal masuk dalam satu ruang pelajar.", "home.create": "Buat daftar", "home.destinationNotice": "Navigasi katalog dan label detail inti telah diterjemahkan. Nama resmi, konten penerimaan, halaman kota, dan panduan tetap berbahasa Inggris selama terjemahan ditinjau.", "home.feedback.search": "Tekan Enter atau Cari untuk melihat hasil katalog yang dipublikasikan.", "home.feedback.empty": "Masukkan program, universitas, beasiswa, atau kota.",
    },
    ms: {
      ...
      "home.boundaryTitle": "Batas penting permohonan", "home.boundaryBody": "CUAC membantu mencari dan menyusun pilihan. Dalam keluaran ini, pelajar menghantar dokumen melalui saluran rasmi setiap universiti.", "home.accountTitle": "Satukan pilihan pengajian di China", "home.accountBody": "Simpan program, bandingkan laluan dan jejak pengambilan dalam satu ruang pelajar.", "home.create": "Cipta senarai", "home.destinationNotice": "Navigasi katalog dan label butiran teras telah diterjemahkan. Nama rasmi, kandungan kemasukan, halaman bandar dan panduan kekal dalam bahasa Inggeris sementara terjemahan disemak.", "home.feedback.search": "Tekan Enter atau Cari untuk melihat hasil katalog yang diterbitkan.", "home.feedback.empty": "Masukkan program, universiti, biasiswa atau bandar.",
    },
    ar: {
