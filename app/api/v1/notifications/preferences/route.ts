...
export const GET = secureApiRoute("GET", async function GET(request: Request) {
  return getNotificationRouteHandler()(request, "getPreferences");
});

export const PUT = secureApiRoute("PUT", async function PUT(request: Request) {
  return getNotificationRouteHandler()(request, "updatePreferences");
});
