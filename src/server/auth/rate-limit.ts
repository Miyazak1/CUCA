...
export const AUTH_RATE_LIMIT_ACTIONS = [
  ...
  "auth.school_staff_invite.activate",
...
export const DEFAULT_AUTH_RATE_LIMIT_RULES: Record<AuthRateLimitAction, AuthRateLimitRule> = {
  ...
  "auth.mfa.enrollment": { maxAttempts: 5, windowSeconds: 900 },
  "auth.mfa.complete": { maxAttempts: 10, windowSeconds: 900 },
  ...
  "auth.school_staff_invite.activate": { maxAttempts: 10, windowSeconds: 900 },
