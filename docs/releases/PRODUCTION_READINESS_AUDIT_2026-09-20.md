...
| Main server suite | 702/702 pass, plus 15/15 focused data-rights tests | The complete server suite and focused student/Ops rights tests, including the simplified approval matrix and thin non-execution route boundary, detached reproducible migration package, Auth-email invitation templates, legal policy schemas and tamper rejection, are green. |
| Real PostgreSQL rehearsal | 422 tests pass | PostgreSQL 16.15 applied and replayed the complete migration chain, matched 85 tables/1,297 columns/495 constraints/326 indexes, exercised student ownership, grant-bound Ops triage, single-operator outcomes, administrator step-up and different-person approval without executing a request, then removed the disposable database afterward. |
| Migration release | Pass | The detached release was reproduced as `3af859e8c4ebef96abdab4602946eb3e48abd57e72e575cdc29efbd8b50c71b5` with 15 pinned runtime dependencies. |
