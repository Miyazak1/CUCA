...
| Main server suite | 702/702 pass, plus 18/18 focused data-rights tests | The complete server suite and focused student/Ops rights tests, including password-step-up identity evidence, database-clock deadline classification, the simplified approval matrix and thin non-execution route boundary, detached reproducible migration package, Auth-email invitation templates, legal policy schemas and tamper rejection, are green. |
| Real PostgreSQL rehearsal | 422 tests pass | PostgreSQL 16.15 applied and replayed the complete migration chain, matched 86 tables/1,309 columns/499 constraints/330 indexes, proved historical deadline backfill, bounded extension dates, unconfirmed-claim denial and retained one-way confirmation evidence, exercised grant-bound Ops triage and risk-proportional outcome approval without executing a request, then removed the disposable database afterward. |
| Migration release | Pass | The detached release was reproduced as `d38a220da268ada2c24860ac91de01882eea5b34f1e8584356d04e01b772d597` with 15 pinned runtime dependencies. |
