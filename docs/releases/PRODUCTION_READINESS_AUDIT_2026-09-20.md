...
| Main server suite | 702/702 pass, plus 17/17 focused data-rights tests | The complete server suite and focused student/Ops rights tests, including password-step-up identity evidence, the simplified approval matrix and thin non-execution route boundary, detached reproducible migration package, Auth-email invitation templates, legal policy schemas and tamper rejection, are green. |
| Real PostgreSQL rehearsal | 422 tests pass | PostgreSQL 16.15 applied and replayed the complete migration chain, matched 86 tables/1,305 columns/498 constraints/329 indexes, proved that an unconfirmed request cannot be claimed, retained only one-way confirmation evidence after account deletion, exercised grant-bound Ops triage, single-operator outcomes, administrator step-up and different-person approval without executing a request, then removed the disposable database afterward. |
| Migration release | Pass | The detached release was reproduced as `f40d49c1c9a5f1bb739f31a40a4d58016594849c7797f029f37ca0cf852af9bc` with 15 pinned runtime dependencies. |
